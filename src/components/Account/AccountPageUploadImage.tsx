...
import { RegisterRestaurantCrop } from "../RegisterRestaurant/RegisterRestaurantCrop";

interface Props {
  setCropResult: React.Dispatch<React.SetStateAction<string>>;
}
export const AccountPageUploadImage: React.FC<Props> = ({ setCropResult }) => {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center" }}>
      <Popup
        ...
        trigger={
          <button className="register-restaurant-upload-input-trigger account-area">
            <svg
